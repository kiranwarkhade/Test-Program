...
public class OrderBuilder {
	public OrderedItems preparePizza() throws IOException {
		...
		System.out.println("        3. ColdDrinks");
		...
		case 1: {
			...
			case 1: {
				...
				case 3:
					...
					break;
				case 4:
					itemsOrder.addItems(new ExtraLargeCheeze());break;
			...
			case 2: {
				...
				/*
				 * case 4: itemsOrder.addItems(new ExtraLargeOnionPizza()); break;
				 */
			...
			case 3: {
				...
				case 3:
					itemsOrder.addItems(new LargeMalsalaPizza());
					break;

				/*
				 * case 4: itemsOrder.addItems(new ExtraLargeMasalaPizza()); break;
				 */
		...
		case 2: {
			...
			/*
			 * case 4: itemsOrder.addItems(new ExtraLargeNonVegPizza()); break;
			 */
			}System.out.println("   Order Successful");
		...
		case 1: {
			...
			/*
			 * case 3: itemsOrder.addItems(new LargePepsi()); break;
			 */
		...
		case 2: {
			...
			/*
			 * case 3: itemsOrder.addItems(new LargeCoke()); break;
			 */
...
break;
		...
		case 3:
			 ...
			 {
				System.out.println("You ordered Jira ");
				System.out.println("Enter the  Jira Size ");
				System.out.println("------------------------");
				System.out.println("    1. Small Jira ");
				System.out.println("    2. Medium Jira ");
				System.out.println("    3. Large Jira ");
				System.out.println("------------------------");
				int jirasize = Integer.parseInt(br.readLine());
				switch (jirasize) {
				case 1:
					itemsOrder.addItems(new SmallJira());
					break;

				case 2:
					itemsOrder.addItems(new MediumJira());
		...
		default: {
			//System.out.println("   Order Un-Successful" + "  ||  Try Again!!!");
			break;
